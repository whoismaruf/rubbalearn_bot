...
import json
import pickle
intents_file = open(r"C:\Users\Rufat\Desktop\chatbot project (1)\intents.json").read()
...
import pandas as pd
text = pickle.dump(words,open('words.pkl','wb'))
...
intents = json.loads(open(r"C:\Users\Rufat\Desktop\chatbot project (1)\intents.json").read())
...
EntryBox = Text(root, bd=0, bg="white",width="60", height="5", font="Arial")
